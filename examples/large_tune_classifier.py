            ...
            for lr in lrs:
                for nepoch in nepochs:
                    ...
                    subprocess.call("python run_classifier.py --task_name jigsaw --do_train --do_lower_case         \
                            --data_dir /hdfs/input/xiaguo/ --bert_model bert-large-uncased --max_seq_length {}      \
                            --train_batch_size {} --learning_rate {} --num_train_epochs {}                          \
                            --output_dir {} --gradient_accumulation_steps 2".format(msl, bs, lr, nepoch, output_dir), shell=True)
